module Admin::ProfileHelper
  def admin_profile_status_badge(admin_profile)
    if admin_profile.discarded?
  ...
  def admin_profile_actions(admin_profile)
    links = []
    
    links << link_to(admin_profile, class: "text-dark") do
      content_tag(:i, "", class: "fa-regular fa-eye")
    end

    links << link_to(edit_admin_profile_path(admin_profile), class: "text-warning") do
      content_tag(:i, "", class: "fa-regular fa-edit")
    end

    if admin_profile.discarded?
      links << link_to(undiscard_admin_profile_path(admin_profile),
        class: "text-success",
        data: {
      ...
      links << link_to(discard_admin_profile_path(admin_profile),
        class: "text-danger",
        data: {
          controller: "sweetalert",
          action: "click->sweetalert#confirmAlert",
